...
public class AbortCommand extends AbstractSingleJobCommand {
    ...
    @Override
    protected CharSequence getMessageForJob(AbstractProject<?, ?> project, JBotSender sender, String[] args) throws CommandException {
        ...
        if (project.isInQueue()) {
            aborted = Jenkins.getInstance().getQueue().cancel(project);
        }
