...
public abstract class AbstractTextSendingCommand extends JBotCommand {
	 ...
	 * {@inheritDoc}
	 */
	public final void executeCommand(Bot bot, JBotChat chat, JBotMessage message,
	 ...
	 */
	protected abstract String getReply(Bot bot, JBotSender sender, String args[]);

    protected String getErrorReply(JBotSender sender, CommandException e) {
